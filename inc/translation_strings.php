<?php
pll_register_string("Army Forum", "Army Forum", 'ninthage');
pll_register_string("Army Forum Description", "Join discussions on your armies strategies, list building and news", 'ninthage');
pll_register_string("Army Miniatures", "Army Miniatures", 'ninthage');
